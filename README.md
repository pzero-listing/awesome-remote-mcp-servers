...
| PZERO | Cloud & Infra / Language Models | `https://mcp.pzero.studio/mcp` | API Key (Bearer) | [PZERO](https://pzero.studio) || Prisma Postgres | Database |  `https://mcp.prisma.io/mcp` | OAuth2.1 | [Prisma Postgres](https://www.prisma.io/docs/postgres/integrations/mcp-server#remote-mcp-server)
